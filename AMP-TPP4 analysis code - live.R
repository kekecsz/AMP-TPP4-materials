...
### Confirmatory data analysis code of the AMP-TPP4 - human trials at preregistration
...
# live account experimenter ID hash: b4ddf1fa1aa4b5153dedae5fc44b21ad6a854dccacd4436742dda1013138dc13
data_nontest = raw_data %>% 
  filter(experimenter_ID_code == "b4ddf1fa1aa4b5153dedae5fc44b21ad6a854dccacd4436742dda1013138dc13")     # live account
